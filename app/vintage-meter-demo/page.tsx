...
import VintageAudioMeter from "@/components/vintage-audio-meter"
import { Button } from "@/components/ui/button"

export default function VintageMeterDemo() {
  ...
  return (
    <div className="min-h-screen bg-[#1a1015] flex flex-col items-center justify-center p-6">
      <div className="p-8 border border-[#3a2a30] bg-[#2a1a20] rounded-sm max-w-md w-full">
        <h1 className="text-xl font-semibold text-[#f0e6c8] mb-6 text-center">Vintage Audio Meter</h1>
        ...
        <div className="flex justify-center mb-8">
          ...
          >
            {isActive ? (
              <VintageAudioMeter barCount={barCount} />
            ) : (
        ...
        <div className="space-y-4">
          <div className="flex justify-center space-x-4">
            ...
            <Button
              onClick={() => setBarCount(Math.max(12, barCount - 4))}
              className="channel-button"
              disabled={barCount <= 12}
            >
              FEWER BARS
            </Button>
          ...
          <div className="text-center text-sm text-[#a09080]">Current configuration: {barCount} bars</div>

          <div className="text-center text-xs text-[#a09080] mt-4">
            This version closely matches the screenshot with cream background and dark bars
          </div>
        </div>
      </div>
    </div>
